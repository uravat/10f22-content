...
**Exercise:** Write a `repeat` loop that prints out the integers from 1 through 3, inclusive.
...
**Exercise (i):** Write a `while` loop to print the numbers 1 - 5. (From here on out, assume that number ranges are inclusive, unless otherwise specified.)
...
**Exercise (ii):** Write a `while` loop to compute the square of numbers 1 - 6.
...
Write a `for` loop that iterates over the numbers 1 through 7 and prints the cube of each number using `print()`.
