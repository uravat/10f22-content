...
date: "Due on Gradescope 30 mins after Section following Lecture 1"
output:
  html_document:
    theme: readable
    toc: yes
...
There are many built-in functions to make calculations easier. For example, calculate the $\sqrt{64}$ using the square root function `sqrt()` \

**(a)** Calculate $\displaystyle \sqrt{ \frac{4^{0.213}}{1 + \ln\left( \frac{7}{3} \right)}  }$

`r bfcolor("Solutions:", "blue")`

**(b)** Calculate $\displaystyle \frac{1}{1 + \frac{1}{1 + \frac{1}{1 + 2}}}$
...
**(a)** Initialize a new random variable called `x`, and assign it the value 2.

`r bfcolor("Solutions:", "blue")`

**(b)** Now assign the value 4 to `x`.

`r bfcolor("Solutions:", "blue")`

**(c)** Write `R` code to add 3 to whatever is the value of `x`. Don't store this new value, and don't just print the number "7".
...
**(e)** Compute the median number of miles per gallon of the cars included in the `mtcars` dataset. Assign this median value to a variable. Be sure to name the variable appropriately. 
...
**(g)** **FTC: Optional, Extra** Using the print and paste function, print "The median number of miles per gallon of cars included in the mtcars dataset is xxxx." Your statement should have xxx replaced by the value of median you calculated earlier. 
