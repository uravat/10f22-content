...
date: "Due on Canvas by 11:59pm on Wednesday October 5"
output:
  html_document:
    toc: yes
---
...
**(e)** Retrieve Alice's score in two ways.
...
**(f)** Retrieve Amy's and Alice's score, in that order.
...
**(g)** Retrieve the scores of everyone except Amy.
