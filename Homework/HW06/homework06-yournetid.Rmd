...
date: "Due on Canvas by 11:59pm on Week 8 Wednesday November 16"
output:
  html_document:
    theme: readable
    toc: yes
...
- Remember to save your `.Rmd` file as `hw06-yournetid.Rmd`
...
- **TEACHING ASSISTANT**
    ...
    - `OFFICE_NO`: a unique office identification number.
...
For the above database, identify the primary keys and foreign keys. When listing the foreign keys, use the syntax introduced on Worksheet 13: i.e. `TableName.ForeignKey -> Table2Name.PrimaryKey`
