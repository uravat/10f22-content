...
## We will start working on this worksheet in lecture and you will complete it during first discussion section and submit your knitted pdf/html file to Canvas using the submission link for Worksheet 00. Read the bottom of this file for information about PSTAT 10 Welcome clinics to help you off to a great start in PSTAT 10!
...
**Exercise 4:** Knit the document and check that the code chunk labled `pressure` did not print. After the **Solution 4:** text below, add a statement  so that we can verify that you completed the above exercise successfully or mention any difficulties you encountered or help received to complete this exercise.
...
Add your code chunk below beginning with the text **Solution 5:** and ending with a statement so that we can verify that you completed the above exercise successfully or  mention any difficulties you encountered or help received to complete this exercise. 
...
From now on, you should make it a point to add text **Solution :** whenever you begin solving an exercise in class, discussion or homework and also summarize your findings or any help received  from doing the exercise **whether or not** we explicitly ask you to document it.
...
b. that you can knit your worksheet into html/pdf
c. You have changed the author name in YAML to your information.
d. **(Optional for this worksheet, necessary for future assignments:)** We appreciate if you change the file name to Worksheet01_yournetid.Rmd by going to files pane, selecting the worksheet and then using the Rename button. By doing so you will have to close this document, open it with it's new name and knit it again to get the pdf/html for submission. In future, it'll be better to copy the original file  by selecting it from the file list, and use copy to to copy it to the same directory with the new name Worksheet01_yournetid.Rmd
e. Download your knitted html/pdf document and upload it to Canvas Worksheet 00 submission link within 30 mins after your section ends.

**Note** For this worksheet only, I will allow you an extended no penalty extension to complete and upload your worksheet by Week 1 Friday 8am. There will be PSTAT 10 Welcome clinics hosted by our PSTAT 10 ULA's on Friday September 23rd to help you work through this worksheet. Please check Canvas for times and locations of these PSTAT 10 Welcome clinics. There will be bonus points allocated for stopping by, saying hello to a ULA and asking them something about the course or PSTAT department in general. ULAs will be a great resource, stop by and ask them how they can help you!
